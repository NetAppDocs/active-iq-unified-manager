...
---
= Upgrade the Active IQ Unified Manager virtual appliance
:icons: font
:imagesdir: ../media/

[.lead]
You can upgrade the Active IQ Unified Manager virtual appliance from releases 9.14 or 9.16 to 9.18.
