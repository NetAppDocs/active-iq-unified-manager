...
summary: "The VMware vSphere system on which you install Unified Manager requires a specific version of the operating system and specific versions of the supporting software."
---
= Learn about VMware software and installation requirements for Active IQ Unified Manager
:icons: font
:imagesdir: ../media/

[.lead]
The VMware vSphere system on which you install Unified Manager requires a specific version of the operating system and specific versions of the supporting software.

== Operating system software

The supported operating system is VMware ESXi 8.0.

[NOTE]
====
Unified Manager OVA on VMware vSphere systems runs Debian OS 13 (Trixie) internally. For information about the versions of the virtual machine hardware that the supported versions of ESXi servers can support, refer to the VMware documentation.
====
//BURT 1473910
...
// 2025-7-17, OTHERDOC 136
// 2026-05-25, OTHERDOC 224