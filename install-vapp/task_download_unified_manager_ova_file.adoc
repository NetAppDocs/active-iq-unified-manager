...
The installation file is a `.tar` file that contains a root certificate, a README file, and an `OVA` file containing Unified Manager software configured in a virtual appliance.
