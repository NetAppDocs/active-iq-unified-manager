...
---
= Active IQ Unified Manager virtual appliance upgrade workflow
:icons: font
:imagesdir: ../media/

[.lead]
 
You can upgrade Active IQ Unified Manager to release 9.18 from release 9.14 or 9.16 only.
...
[NOTE]
====
If your system was upgraded from Unified Manager 9.7, you cannot upgrade directly from 9.14 to 9.18 because of file system changes in the Debian versions. Instead, follow this recommended upgrade path:
9.14 -> 9.16P2 -> 9.18.
====
