...
---
= Learn about the Active IQ Unified Manager deployment process
:icons: font
:imagesdir: ../media/
...
image::../media/deployment_sequence_oc_6_0.gif["A diagram that shows Unified Manager deployment prerequisites, appliance deployment, and initial configuration steps"]
