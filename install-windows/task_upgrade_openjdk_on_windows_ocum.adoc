...
---
= Upgrade OpenJDK on Windows for Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
+
[NOTE]
 An Oracle account is required to download the file. If you do not have an Oracle account, go to link:https://signon.oracle.com/signin[the Oracle account sign-in page] to create one. 
