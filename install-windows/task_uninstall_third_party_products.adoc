...
---
= Uninstall third-party products for Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
. Select *Uninstall this program*. Uninstall any version of Python except for 3.13.3. Ensure that you retain Python version 3.13.3.
