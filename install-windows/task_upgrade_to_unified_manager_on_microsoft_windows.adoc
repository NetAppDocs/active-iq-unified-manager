...
include::../include/upgrade-path.adoc[]
...
* MySQL Community Edition is automatically upgraded during Unified Manager upgrade. If the installed version of MySQL on your system is earlier than 8.0.28, the Unified Manager upgrade process automatically upgrades MySQL to 8.0.28. You must not run a standalone upgrade of an earlier version of MySQL to 8.0.27.
