...
---
= Upgrade Active IQ Unified Manager on Windows
:icons: font
:imagesdir: ../media/

[.lead]
You can upgrade Unified Manager 9.14 or 9.16 to 9.18 by downloading and running the installation file on the Windows platform.
