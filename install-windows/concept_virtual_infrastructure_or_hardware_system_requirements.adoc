...
---
= Understand virtual infrastructure and hardware requirements for Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
Additionally, there is a limit to the number of nodes that a single instance of Unified Manager can monitor before you install a second instance of Unified Manager. For node limits, CPU, and memory recommendations, see https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf[the Unified Manager Best Practices Guide^].
