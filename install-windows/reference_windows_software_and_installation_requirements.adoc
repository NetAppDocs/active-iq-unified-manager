...
---
= Understand Windows software and installation requirements for Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
:pp: {plus}{plus}
...
* Microsoft Visual C{pp} Redistributable Packages for Visual Studio 2015 version 14.29.30133.0
* MySQL Community Edition version 8.4.10
* Python 3.13.3
* OpenJDK version 17.0.15+6
* 7-zip version 25.01 or later
...
// 2025-6-17, OTHERDOC135
// 2025-10-8, OTHER DOC 152 
