...
* Microsoft Visual C{pp} Redistributable Packages for Visual Studio 2015 version 14.26.28720.3
* MySQL Community Edition version 8.4.7
* Python 3.13.3
* OpenJDK version 17.0.14+6
* 7-zip version 24.09 or later
