...
. If you downloaded the zip file, unzip the file to find the installation file. If you downloaded the installation file, navigate to the directory where the installation file is located.
