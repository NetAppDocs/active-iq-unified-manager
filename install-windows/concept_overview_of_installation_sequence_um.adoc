...
---
= Learn about the installation sequence for Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
image::../media/overall_um_install_flow.png["A diagram that shows Unified Manager installation, initial setup, and administrative settings workflows"]
