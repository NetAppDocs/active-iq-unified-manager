...
For more information about using ONTAP REST APIs, see link:https://docs.netapp.com/us-en/ontap-automation/understanding_rest.html[Understanding the ONTAP REST API]
