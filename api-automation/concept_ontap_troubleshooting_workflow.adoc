...
---
= Troubleshoot ONTAP volumes by using Active IQ Unified Manager gateway APIs
:icons: font
:imagesdir: ../media/
...
image::../media/api_gateway_ontap_workflow.gif["A diagram that shows Unified Manager and ONTAP API steps for troubleshooting volume capacity alerts"]
