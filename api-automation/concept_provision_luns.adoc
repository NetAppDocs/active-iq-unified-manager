...
---
= Provision LUNs by using Active IQ Unified Manager APIs
:icons: font
:imagesdir: ../media/
...
image::../media/create_luns.gif["A diagram that shows the workflow for creating a LUN, including Storage VM, service level, and igroup steps"]
