...
---
= Provision CIFS and NFS file shares by using Active IQ Unified Manager APIs
:icons: font
:imagesdir: ../media/
...
image::../media/create_fileshares.gif["A diagram that shows a CIFS and NFS file share provisioning workflow, from SVM setup through share creation"]
