...
---
= Determine space issues in aggregates by using Active IQ Unified Manager APIs
:icons: font
:imagesdir: ../media/
...
image::../media/space_utilization.gif["A flowchart for identifying overutilized autosize-mode enabled volumes in cluster aggregates"]
