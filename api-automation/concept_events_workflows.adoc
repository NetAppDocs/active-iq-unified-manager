...
---
= Determine storage object issues using Active IQ Unified Manager event APIs
:icons: font
:imagesdir: ../media/
...
image::../media/handling_event_related_issues_of_a_storage_object_flowchart.gif["A flowchart showing volume event analysis from listing events through corrective action to end"]
