...
---
= Manage events and alerts by using APIs in Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
For more information about events, see link:../events/concept_manage_events.html[Manage events].
...
For more information about alerts, see link:../events/concept_manage_alerts.html[Manage alerts].
...
For more information about scripts, see link:../events/concept_manage_scripts.html[Manage scripts].
