...
https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/concept_roles_of_workloads_involved_in_performance_incident.html:[Roles of workloads involved in a performance event]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/health-checker/concept_cluster_components_and_why_they_can_be_in_contention.html:[Cluster components and why they can be in contention]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/events/reference_event_details_page.html:[Event details page]
