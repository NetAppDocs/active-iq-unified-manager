...
https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/concept_performance_incident_analysis_for_metrocluster_configuration.html:[Performance event analysis for a MetroCluster configuration]
