...
+
See https://docs.netapp.com/us-en/active-iq-unified-manager_main/storage-mgmt/concept_fix_ontap_issues_directly_from_unified_manager.html[Fixing ONTAP issues directly from Unified Manager] for more information.
...
https://docs.netapp.com/us-en/active-iq-unified-manager_main/events/task_fix_issues_using_um_automatic_remediations.html:[Fixing issues using Unified Manager automatic remediations]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/task_display_information_about_performance_event.html:[Displaying information about performance events]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/concept_manage_performance_using_perf_capacity_available_iops.html:[Managing performance using performance capacity and available IOPS information]

link:[What health events are]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/reference_performance_event_analysis_and_notification.html:[Performance event analysis and notification]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/events/reference_description_of_event_severity_types.html:[Description of event severity types]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/concept_sources_of_performance_events.html:[Sources of performance events]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/health-checker/concept_manage_cluster_security_objectives.html:[Managing cluster security objectives]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/concept_monitor_cluster_performance_from_cluster_landing_page.html:[Monitoring cluster performance from the Performance Cluster Landing page]

https://docs.netapp.com/us-en/active-iq-unified-manager_main/performance-checker/concept_monitor_performance_using_object_performance.html:[Monitoring performance using the Performance Inventory pages]
