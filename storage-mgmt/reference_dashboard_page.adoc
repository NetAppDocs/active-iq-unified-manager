...
---
= Learn about the Active IQ Unified Manager Dashboard page
:icons: font
:imagesdir: ../media/
...
See link:concept_fix_ontap_issues_directly_from_unified_manager.html[Fix ONTAP issues directly from Unified Manager] for more information.
...
link:../health-checker/concept_manage_cluster_security_objectives.html[Manage cluster security objectives]

link:../performance-checker/concept_monitor_cluster_performance_from_cluster_landing_page.html[Monitor cluster performance from the Performance Cluster Landing page]

link:../performance-checker/concept_monitor_performance_using_object_performance.html[Monitor performance using the Performance Inventory pages]
