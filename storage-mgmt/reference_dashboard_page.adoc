...
You can click the counts and the bar charts to go into the Clusters and Storage VMs pages to view the security details for the respective clusters and storage VMs. 
