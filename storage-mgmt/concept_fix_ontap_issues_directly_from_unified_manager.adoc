...
For information about the ONTAP issues and features that you can manage by using  automatic remediation, see link:../reference_what_ontap_issues_can_unified_manager_fix.html[What issues can Unified Manager fix]
