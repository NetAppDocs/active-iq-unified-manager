...
---
= Add clusters to Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
+
This account must have the _admin_ role with Application access set to _ontapi_, _amqp_, _console_, and _http_.
//BURT 1452466

** You must know the port number to connect to the cluster using the HTTPS protocol (typically port 443).
** The cluster must be running ONTAP version 9.9 software or greater.
