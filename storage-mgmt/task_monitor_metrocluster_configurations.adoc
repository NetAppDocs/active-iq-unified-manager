...
---
= Monitor MetroCluster configurations in Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
For more information about determining cluster health, see link:../health-checker/task_check_health_of_clusters_in_metrocluster_configuration.html#determine-cluster-health-in-metrocluster-over-fc-configuration[Determine cluster health in MetroCluster over FC configuration].
...
* For information about *Relationship:MetroCluster* view, see link:../storage-mgmt/task_monitor_metrocluster_configurations.html[Monitor MetroCluster configurations].
