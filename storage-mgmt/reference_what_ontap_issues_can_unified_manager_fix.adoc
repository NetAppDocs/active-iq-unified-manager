...
Periodically checks for clusters with licenses for anti-ransomware monitoring. Detects whether the volumes are in the `learning` mode of anti-ransomware monitoring for about 45 days, and determines the prospect of putting them in active mode.
a|
