...
image::../media/capacitysums.png[A UI screenshot that shows the total capacity based on current data.]
...
+
image::../media/cluster_column_chart_2.png[A UI screenshot that shows the chart with total data and committed capacity.]
...
+
image::../media/upload_excel.png[A UI screenshot that shows how to upload excel from reports.]
