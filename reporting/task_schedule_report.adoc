...
. You can use the advanced features of Microsoft® Excel to customize your report. For details, see xref:task_use_excel_to_customize_your_report.adoc[Using Excel to customize your report].
