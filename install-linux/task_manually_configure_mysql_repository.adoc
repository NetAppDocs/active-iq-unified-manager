...
For Red Hat Enterprise Linux 8 system, if you have internal repositories with java-17-openjdk, p7zip, and other software packages provided by the AppStream repository, you must disable your AppStream repository and install MySQL Community Server. Run the following command:
