...
---
= Upgrade Active IQ Unified Manager
:icons: font
:imagesdir: ../media/

[.lead]
You can upgrade from Unified Manager 9.14 or 9.16 to 9.18 by downloading and running the installation file on the Linux platform.
...
+
* You must install or upgrade to the correct version of 7-zip prior to upgrading Unified Manager. 
See link:task_configure_7zip_package.html[Configure the 7-zip software package]. 
+
...
* MySQL Community Edition is automatically upgraded during Unified Manager upgrade. If the installed version of MySQL on your system is earlier than 8.4.10, the Unified Manager upgrade process automatically upgrades MySQL to 8.4.10.
...
// 2025-06-11, OTHERDOC-133
// 2025-05-26, OTHERDOC 127
// 2025-09-29, OTHERDOC 152
