...
+
If your site does not have a repository configured with MySQL 8.0.25 or later, you might not be able to upgrade Unified Manager. To configure the repository before upgrade, follow these steps:
