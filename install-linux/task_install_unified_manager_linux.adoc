...
---
= Install Active IQ Unified Manager on Red Hat Enterprise Linux
:icons: font
:imagesdir: ../media/
...
. If the installed version of MySQL is earlier than MySQL 8.4.10 Community Edition, enter the following command to uninstall it:
+
...
+
For a Red Hat Enterprise Linux 8 system, if you have internal repositories with JDK 17 - OpenJDK, 7-zip, and other software packages provided by the AppStream repository, you must disable your AppStream repository and install MySQL Community Server. Run the following command:
+
----
