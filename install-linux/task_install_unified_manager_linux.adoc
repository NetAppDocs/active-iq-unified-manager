...
. If the installed version of MySQL is earlier than MySQL 8.4.4 Community Edition, enter the following command to uninstall it:
+
...
+
For a Red Hat Enterprise Linux 8 system, if you have internal repositories with JDK 17 - OpenJDK, p7zip, and other software packages provided by the AppStream repository, you must disable your AppStream repository and install MySQL Community Server. Run the following command:
+
----
