...
Access the web UI to change the default password of the umadmin user, and perform the initial setup of Unified Manager, as described in the https://docs.netapp.com/us-en/active-iq-unified-manager_main/config/index.html[Active IQ Unified Manager System Configuration Guide].
