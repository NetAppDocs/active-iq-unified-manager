...
* MySQL Community Edition version 8.4.4 (from the MySQL repository) 
* OpenJDK version 17.0.14+6 (from the Red Hat Extra Enterprise Linux Server repository)
* Python 3.12 (from the Red Hat Extra Enterprise Linux Server repository)
* 7zip version 7z2301-linux-x64. For more information view link:task_configure_7-zip-package.html[Configure 7-zip package].
