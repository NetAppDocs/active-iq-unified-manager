...
---
= Learn about Linux software and installation requirements in Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
* Red Hat Enterprise Linux versions 8.x and 9.6, based on x86_64 architecture.
...
Unified Manager is deployed on a WildFly web server. WildFly 27.0.1.Final is bundled and configured with Unified Manager.
...
* MySQL Community Edition version 8.4.10 (from the MySQL repository) 
* OpenJDK version 17.0.14+6 (from the Red Hat Extra Enterprise Linux Server repository)
* Python 3.13.3 (from the Red Hat Extra Enterprise Linux Server repository)
* 7zip version 7z2301-linux-x64. For more information, view link:task_configure_7zip_package.html[Configure the 7-zip software package].
...
// 2025-9-29, OTHERDOC 152
// 2025-01-13, OTHERDOC 181 