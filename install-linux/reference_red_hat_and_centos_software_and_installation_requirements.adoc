...
* Red Hat Enterprise Linux version 7.x and 8.x based on x86_64 architecture.
...
* MySQL Community Edition version 8.0.30 (from the MySQL repository).
* OpenJDK version 11.0.17 (from the Red Hat Extra Enterprise Linux Server repository)
* Python 3.6.x
