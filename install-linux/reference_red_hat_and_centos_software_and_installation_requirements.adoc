...
* Red Hat Enterprise Linux version 7.x and 8.x or CentOS version 7.x, based on x86_64 architecture. CentOS Stream is not supported.
...
* MySQL Community Edition version 8.0.28 (from the MySQL repository).
* OpenJDK version 11.0.14 (from the Red Hat Extra Enterprise Linux Server repository)
* Python 3.6.x
