...
---
= Understand the installation sequence for Active IQ Unified Manager on Red Hat Enterprise Linux
:icons: font
:imagesdir: ../media/
...
image::../media/install_flow_on_rhel_2026.png["A diagram that shows prerequisites, Unified Manager installation, and initial configuration workflows on Red Hat Linux"]
