...
---
= Use the supported upgrade path for versions of Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
Not all versions of Unified Manager can perform an in-place upgrade to later versions. The Unified Manager upgrades are limited to an N-2 model. This means that you can only perform an upgrade to the next two releases on all platforms. For example, you can perform an upgrade to Unified Manager 9.18 from Unified Manager 9.14 and 9.16 only. 
