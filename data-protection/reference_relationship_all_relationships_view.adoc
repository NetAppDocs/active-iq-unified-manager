...
+
Displays the type of object used in the relationship. You can view Consistency Group as one of the types of relationship.
...
You can view volumes enabled with SnapMirror Business Continuity (SM-BC) consistency group and the synchronous consistency group relationship as well.
