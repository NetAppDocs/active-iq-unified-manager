...
---
= Restore data using the Volume and Volume/Health details pages in Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
* You can't restore a directory or a volume from a snapshot in any of the following scenarios:
