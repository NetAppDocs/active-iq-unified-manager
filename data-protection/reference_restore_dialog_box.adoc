...
xref:task_restore_data_use_health_volumes_page.adoc[Restoring data using the Health: All Volumes view]

xref:task_restore_data_use_health_volume_details_page.adoc[Restoring data using the Volume / Health details page]
