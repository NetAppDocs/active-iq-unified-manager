...
To know more about SnapMirror Synchronous Business Continuity, refer to link:https://docs.netapp.com/us-en/ontap/smbc/index.html[ONTAP 9 Documentation for Snapmirror active sync (formerly SM-BC)].
