...
To know more about SnapMirror Synchronous Business Continuity, refer to the link:https://docs.netapp.com/us-en/ontap/smbc/index.html[ONTAP 9 Documentation for SM-BC].
