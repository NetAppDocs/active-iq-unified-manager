...
---
= Disable alerts for Resolved and Obsolete events in Active IQ Unified Manager
:icons: font
:imagesdir: ../media/

[.lead]
For all events that you have configured to send alerts, an alert message is sent when those events transition through all available states: New, Resolved, and Obsolete. If you do not want to receive alerts for events as they move into the Resolved and Obsolete states, you can configure a global setting to suppress those alerts.
