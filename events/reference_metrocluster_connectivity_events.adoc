...
Critical
a|
MetroCluster Disaster Recovery Capabilities Impacted(ocumEvtMetroClusterDRStatusImpacted)
a|
Risk
a|
MetroCluster relationship
...
Critical
a|
MetroCluster Configuration SwitchOver(ocumEvtMetroClusterDRStatusImpacted)
a|
Risk
a|
MetroCluster relationship
