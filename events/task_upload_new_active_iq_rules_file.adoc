...
+
[NOTE]
On Windows systems, in an unconnected site, the NetApp KB article is not bundled by default with the installer. You can download the _secure_rules.zip_ from the support site and upload it to view the KB article for all applicable rules.
