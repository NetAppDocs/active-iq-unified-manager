...
summary: "You should configure the volume for storing Snapshot copies for backing up Unified Manager on Windows."
---
...
[.lead]
You should configure the volume for storing Snapshot copies for backing up Unified Manager on Windows.
