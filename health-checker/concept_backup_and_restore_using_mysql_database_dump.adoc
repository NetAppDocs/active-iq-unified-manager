...
---
= Backup and restore using a MySQL database dump in Active IQ Unified Manager
:icons: font
:imagesdir: ../media/
...
image::../media/database_backup.gif["A diagram that shows three backup directory files pointing to full and incremental files in the database repository"]
