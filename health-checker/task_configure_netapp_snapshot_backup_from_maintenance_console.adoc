...
sidebar: sidebar
keywords: configure, netapp, snapshot, copy, maintenance console
summary: "You should configure Active IQ Unified Manager backup to NetApp Snapshot copy from the maintenance console."
---
...
[.lead]
You should configure Active IQ Unified Manager backup to NetApp Snapshot copy from the maintenance console.
