...
link:https://docs.netapp.com/us-en/active-iq-unified-manager/config/task_generate_an_https_security_certificate_ocf.html[Generating an HTTPS security certificate]

link:https://docs.netapp.com/us-en/active-iq-unified-manager/config/task_enable_saml_authentication_um.html[Enabling SAML authentication]
