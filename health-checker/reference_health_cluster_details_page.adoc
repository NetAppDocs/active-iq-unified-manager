...
*** Not Configured
+
The cluster supports mediators, but the mediator is not configured.
*** Not Applicable
+
The cluster doesn't support mediators.
*** IP Address
+
Displays when the cluster supports mediators and the mediator is configured. The color green indicates the mediator is reachable. The color red indicates the mediator is unreachable.
