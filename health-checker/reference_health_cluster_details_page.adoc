...
*** IP Address
+
Displays when the cluster supports mediators and the mediator is configured. The health status of the mediator is indicated by the following colors:
