...
---
= Backup configuration for Active IQ Unified Manager on Linux
:icons: font
:imagesdir: ../media/
...
+
For example, if you created a backup on Unified Manager 9.18, the backup can be restored only on Unified Manager 9.18 systems.
