...
* #MetroCluster over FC and IP configurations: viewing and monitoring the configuration, MetroCluster switches and bridges for MetroCluster ove FC, issues, and connectivity status of the cluster components#
