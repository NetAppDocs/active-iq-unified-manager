...
[NOTE] 
====
For a secure connection to the SMTP server, you should check the box for *Use STARTLS* or *Use SSL* option. If you select the *Use STARTTLS* or *Use SSL* option, a certificate page displays after you click the *Continue* button. Verify the certificate details and accept the certificate to continue with the initial setup settings of the web UI.
====
