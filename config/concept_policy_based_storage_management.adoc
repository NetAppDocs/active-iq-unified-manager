...
https://docs.netapp.com/us-en/active-iq-unified-manager_main/api-automation/concept_get_strated_with_um_apis.html[Active IQ Unified Manager API Developer's Guide]
