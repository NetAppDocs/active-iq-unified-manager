...
** If certificate-based authentication is enabled for a cluster, and you delete the cluster to the Unified Manager server and restore to another Unified Manager server, then monitoring of the cluster can fail. To avoid the failure, edit and save the cluster details. For more information about editing cluster details, see link:../storage-mgmt/task_edit_clusters.html[Editing clusters].
====
+
...
+
If a certificate-based authentication is enabled for a cluster and you delete and restore the cluster to the Unified Manager server, then you can see the failure in monitoring of the cluster. To avoid the failure, edit and save the cluster details. 
