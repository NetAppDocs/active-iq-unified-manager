...
+
If a certifcate-based authentication is enabled for a cluster and you delete and restore the cluster to the Unified Manager server, then you can see the failure in monitoring of the cluster. To avoid the failure, edit and save the cluster details. 
