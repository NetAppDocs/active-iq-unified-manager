...
By default, your session timeout is set to 4,320 minutes (72 hours), which means that your session ends automatically after 72 hours, even if you are logged in and actively using Unified Manager.
