...
. In the Notifications page, configure the appropriate settings. click *Save*.
+
*Notes:*
 ...
 ** For a secure connection to the SMTP server, you should check the box for *Use STARTLS* or *Use SSL* option.
. Click *Save*.
...
+
You can click the *View Certificate Details* button to view the certificate details. If the existing certificate is expired, uncheck the *Use STARTTLS* or *Use SSL* box, save the notification settings, and again check the *Use STARTTLS* or *Use SSL* box to generate a new certificate.
