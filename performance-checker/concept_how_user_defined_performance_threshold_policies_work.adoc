...
---
= How Active IQ Unified Manager uses user-defined performance threshold policies
:icons: font
:imagesdir: ../media/
...
image::../media/opm2_threshold_breach.gif[A UI screenshot that shows an example counter chart.]
