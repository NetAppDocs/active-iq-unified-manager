...
---
= Understand how Active IQ Unified Manager handles a received event
:icons: font
:imagesdir: ../media/
...
image::../media/um_perf_threshold_event_flow.gif["A diagram that shows threshold event processing from counter collection to email notification"]
